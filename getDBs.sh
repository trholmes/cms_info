...
python3 /afs/cern.ch/user/t/tholmes/useful_files/cron_scripts/cms-info/getDB.py 'https://icms-dev.cern.ch/tools-api/restplus/org_chart/tenures?exclude_past=true' > ${loc}tenures_raw.json
