...
# as long as CINCO is behind the old SSO, use lxplus8:
ssh -q lxplus8 "cd cms_info; python3 ./getOldDB.py 'https://cms-mgt-conferences.web.cern.ch/conferences/conferences_list_short.aspx' > ${loc}cinco_raw.json "
